//
//  VLDataFileTransformationServiceVendor.m
...
#import "VLDataFileTransformationServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLDataFileTransformationServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateDataFileBufferWithOptions:options];
