//
//  VLBalanceEquationsTransformationServiceVendor.m
//  ONRMechanicalModelGenerator
//
//  Created by Jeffrey Varner on 7/11/13.
//  Copyright (c) 2013 Varnerlab. All rights reserved.
//

#import "VLBalanceEquationsTransformationServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLBalanceEquationsTransformationServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateBalanceEquationsBufferWithOptions:options];
