//
//  VLCalculateLambdaMatrixFunctionServiceVendor.m
//  ONRMechanicalModelGenerator
//
//  Created by Jeffrey Varner on 7/12/13.
//  Copyright (c) 2013 Varnerlab. All rights reserved.
//

#import "VLCalculateLambdaMatrixFunctionServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCalculateLambdaMatrixFunctionServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateLambdaMatrixFunctionBufferWithOptions:options];
