//
//  VLWriteMySpringConstantMatrixServiceVendor.m
...
#import "VLWriteMySpringConstantMatrixServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLWriteMySpringConstantMatrixServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateSpringConstantMatrixBufferWithOptions:options];
