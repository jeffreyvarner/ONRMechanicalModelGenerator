//
//  VLCalculateExternalForcingFunctionServiceVendor.m
//  ONRMechanicalModelGenerator
//
//  Created by Jeffrey Varner on 7/13/13.
//  Copyright (c) 2013 Varnerlab. All rights reserved.
//

#import "VLCalculateExternalForcingFunctionServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCalculateExternalForcingFunctionServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateExternalForcingBufferWithOptions:options];
