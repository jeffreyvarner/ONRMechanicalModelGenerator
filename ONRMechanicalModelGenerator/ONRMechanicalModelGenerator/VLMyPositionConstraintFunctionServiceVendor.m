//
//  VLMyPositionConstraintFunctionServiceVendor.m
//  ONRMechanicalModelGenerator
//
//  Created by Jeffrey Varner on 7/14/13.
//  Copyright (c) 2013 Varnerlab. All rights reserved.
//

#import "VLMyPositionConstraintFunctionServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLMyPositionConstraintFunctionServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generatePositionConstraintFunctionBufferWithOptions:options];
