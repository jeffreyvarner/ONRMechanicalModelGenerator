//
//  VLCalculateAlphaMatrixFunctionServiceVendor.m
...
#import "VLCalculateAlphaMatrixFunctionServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCalculateAlphaMatrixFunctionServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateAlphaMatrixFunctionBufferWithOptions:options];
