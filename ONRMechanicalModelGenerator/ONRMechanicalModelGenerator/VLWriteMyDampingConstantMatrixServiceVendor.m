//
//  VLWriteMyDampingConstantMatrixServiceVendor.m
...
#import "VLWriteMyDampingConstantMatrixServiceVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLWriteMyDampingConstantMatrixServiceVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateDampingConstantMatrixBufferWithOptions:options];
